                                    ...
                                    <div className="row ">
                                        ...
                                        <div className="col ms-0 mt-3">
                                            <div className="table-responsive">
                                                ...
                                                <div className=' my-3'>
                                            <button type="reset" class="btn btn-light w-25" onClick={navtoadminjob}>Back </button>
                                            <button type="button" class="btn btn-primary w-25" onClick={navtoadminjob} style={{ backgroundColor: "rgb(31, 99, 145)" }}>Delete </button>
